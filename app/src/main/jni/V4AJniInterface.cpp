...
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, "ViPER4Android_v3", __VA_ARGS__)

JNIEXPORT jint JNICALL Java_com_vipercn_viper4android_1v3_activity_V4AJniInterface_CheckLibraryUsable(
            JNIEnv *env, jclass cls) {
    return (jint) 1;
}

JNIEXPORT jint JNICALL Java_com_vipercn_viper4android_1v3_activity_V4AJniInterface_CheckCPUHasNEON(
            JNIEnv *env, jclass cls) {
...
JNIEXPORT jint JNICALL Java_com_vipercn_viper4android_1v3_activity_V4AJniInterface_CheckCPUHasVFP(
            JNIEnv *env, jclass cls) {
    if (android_getCpuFamily() != ANDROID_CPU_FAMILY_ARM) return (jint) 0;
    uint64_t uiCPUFeatures = android_getCpuFeatures();
...
JNIEXPORT jintArray JNICALL Java_com_vipercn_viper4android_1v3_activity_V4AJniInterface_GetImpulseResponseInfo(
...
JNIEXPORT jbyteArray JNICALL Java_com_vipercn_viper4android_1v3_activity_V4AJniInterface_ReadImpulseResponse(
            JNIEnv *env, jclass cls, jbyteArray jbaIRFileName) {
    // Get multi-bytes string
...
JNIEXPORT jintArray JNICALL Java_com_vipercn_viper4android_1v3_activity_V4AJniInterface_HashImpulseResponse(
