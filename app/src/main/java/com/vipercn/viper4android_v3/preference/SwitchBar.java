...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener, View.OnClickListener
{
    ...
    public SwitchBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
        ...
        mLabel = getResources().getString(R.string.disabled);
    ...
    {
        mLabel = getResources().getString(isChecked ? R.string.enabled : R.string.disabled);
        updateText();
    }
    ...
    static class SavedState extends BaseSavedState
    {
        ...
        {
            return "SwitchBar.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " checked=" + checked + " visible=" + visible + "}";
        }
