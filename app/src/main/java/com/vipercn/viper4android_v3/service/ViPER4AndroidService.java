package com.vipercn.viper4android_v3.service;
...
import com.vipercn.viper4android_v3.activity.IRSUtils;
import com.vipercn.viper4android_v3.activity.Utils;
import com.vipercn.viper4android_v3.activity.V4AJniInterface;
...
public class ViPER4AndroidService extends Service
{
    ...
    private class V4ADSPModule
    {
        ...
        V4ADSPModule(int nAudioSession)
        {
            try
            {
                Log.i("ViPER4Android", "Creating viper4android module, " + ViPER4AndroidService.ID_V4A_GENERAL_FX);
                mInstance = AudioEffect.class.getConstructor(UUID.class, UUID.class, Integer.TYPE, Integer.TYPE).newInstance(EFFECT_TYPE_NULL, ViPER4AndroidService.ID_V4A_GENERAL_FX, 0, nAudioSession);
            }
            catch (Exception e)
            {
                Log.e("ViPER4Android", "Can not create audio effect instance," + "V4A driver not installed or not supported by this rom: " + e);
                mInstance = null;
            }
                ...
                mInstance.setControlStatusListener(new AudioEffect.OnControlStatusChangeListener()
                {
                    ...
                    public void onControlStatusChange(AudioEffect effect, boolean controlGranted)
                    {
                        if (!controlGranted)
                        {
                            ...
                            Toast.makeText(ViPER4AndroidService.this, getString(getResources().getIdentifier("text_token_lost", "string", getApplicationInfo().packageName)), Toast.LENGTH_LONG).show();
                        }
                        else
                        {
        ...
        void setParameter_px4_vx4x1(int param, int valueL)
        {
            try
            {
        ...
        void setParameter_px4_vx4x2(int param, int valueL, int valueH)
        {
            try
            {
                byte[] p = intToByteArray(param);
        ...
        void setParameter_px4_vx4x3(int param, int valueL, int valueH, int valueE)
        {
            try
            {
                byte[] p = intToByteArray(param);
        ...
        void setParameter_px4_vx1x256(int param, int dataLength, byte[] byteData)
        {
            try
            {
                byte[] p = intToByteArray(param);
        ...
        void setParameter_px4_vx1x1024(int param, float[] floatData)
        {
            try
            {
                ...
                for (float aFloatData : floatData)
                    byteDataBuffer.putFloat(aFloatData);
                byte[] p = intToByteArray(param);
        ...
        void setParameter_px4_vx2x8192(int param, int valueL, int dataLength, byte[] byteData)
        {
            try
            {
                byte[] p = intToByteArray(param);
        ...
        void setParameter_Native(byte[] parameter, byte[] value)
        {
            if (mInstance == null)
                return;
            try
        ...
        int getParameter_px4_vx4x1(int param)
        {
            try
            {
                byte[] p = intToByteArray(param);
        ...
        void getParameter_Native(byte[] parameter, byte[] value)
        {
            if (mInstance == null)
                return;
            try
        ...
        private void proceedIRBuffer_Headphone(String mConvIRFile, int mChannels, int mFrames)
        {
            ...
            while (mRestBytes > 0)
            {
                ...
                mSendOffset += minBlockSize;
                mRestBytes -= minBlockSize;
                Log.i("ViPER4Android", "Setting kernel buffer, index = " + mPacketIndex + ", length = " + minBlockSize);
                mPacketIndex++;
                // Send to driver
                int mFramesCount = minBlockSize / 4;  /* sizeof(float) = 4 */
        ...
        private void proceedIRBuffer_Speaker(IRSUtils irs, String mConvIRFile)
        {
            ...
            Random rndMachine = new Random();
            int mKernelBufferID = rndMachine.nextInt();
            setParameter_px4_vx4x3(ViPER4AndroidService.PARAM_SPKFX_CONV_PREPAREBUFFER, mKernelBufferID, irs.getChannels(), 0);
            ...
            Log.i("ViPER4Android", "[Kernel] Channels = " + irs.getChannels() + ", Frames = " + irs.getSampleCount() + ", Bytes = " + mKernelData.length + ", Hash = " + hashCode);
        ...
        void setConvIRFile(String mConvIRFile, boolean bSpeakerParam)
        {
            ...
            if (mIrsName.length == 0)
            {
                ...
                Log.i("ViPER4Android", "Kernel ID = [driver: " + irsNameHashInDriver + ", client: " + irsNameHash + "]");
            ...
            int mCommand = bSpeakerParam ? ViPER4AndroidService.PARAM_SPKFX_CONV_PREPAREBUFFER : ViPER4AndroidService.PARAM_HPFX_CONV_PREPAREBUFFER;
            ...
            else if (V4AJniInterface.IsLibraryUsable())
            {
                ...
                else
                {
                    ...
                    else
                    {
                        /* Proceed buffer */
                        if (bSpeakerParam)
                            proceedIRBuffer_Speaker(mConvIRFile, iaIRInfo[1], iaIRInfo[2]);
                        else
                            proceedIRBuffer_Headphone(mConvIRFile, iaIRInfo[1], iaIRInfo[2]);
                    }
                }
            }
            else
    ...
    private final BroadcastReceiver mRoutingReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(final Context context, final Intent intent)
        {
            ...
            Log.i("ViPER4Android", "Headset=" + mUseHeadset + ", Bluetooth=" + mUseBluetooth + ", USB=" + mUseUSB);
            if (prevUseHeadset != mUseHeadset || prevUseBluetooth != mUseBluetooth || prevUseUSB != mUseUSB)
    ...
    private void showNotification(String mFXType)
    {
        ...
        int mIconID = getResources().getIdentifier("icon", "drawable", getApplicationInfo().packageName);
    ...
    private static String getAudioOutputRouting(SharedPreferences prefSettings)
    {
    ...
    private float[] extractDDCCoeffs(SharedPreferences preferences)
    {
        ...
        if (szDeviceDDCCoeffs.equals(""))
        {
            ...
            if ((ddcCoeffs == null) || (ddcCoeffs.length < 2))
                return null;
    ...
    private void setV4AEqualizerBandLevel(int idx, int level, boolean hpfx, V4ADSPModule dsp)
    {
    ...
    private void updateSystem(boolean mRequireReset)
    {
        String mode = getAudioOutputRouting(getSharedPreferences(ViPER4Android.SHARED_PREFERENCES_BASENAME + ".settings", MODE_PRIVATE));
        SharedPreferences preferences = getSharedPreferences(ViPER4Android.SHARED_PREFERENCES_BASENAME + "." + mode, 0);
    ...
    private void updateSystem_Global(SharedPreferences preferences, int mFXType, boolean mRequireReset, boolean mLocalFX)
    {
    ...
    private void updateSystem_Local(SharedPreferences preferences, int mFXType, boolean mRequireReset, boolean mLocalFX)
    {
        if (mV4AMutex.acquire())
        {
            List<Integer> v4aUnderControl = new ArrayList<>();
            for (int idx = 0; idx < mGeneralFXList.size(); idx++)
            {
                Integer sessionId = mGeneralFXList.keyAt(idx);
                V4ADSPModule v4aModule = mGeneralFXList.valueAt(idx);
                ...
                {
                    Log.i("ViPER4Android", String.format("Trouble trying to manage session %d, removing...", sessionId));
    ...
    private void updateSystem_Module(SharedPreferences prefs, int mFXType, V4ADSPModule v4aModule, boolean requireReset, boolean mMasterSwitchOff)
    {
        ...
        if (mFXType == V4A_FX_TYPE_HEADPHONE)
        {
            ...
            float[] ddcCoeffs = extractDDCCoeffs(prefs);
            if (ddcCoeffs != null)
                v4aModule.setParameter_px4_vx1x1024(PARAM_HPFX_VDDC_COEFFS, ddcCoeffs);
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VDDC_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.viperddc.enable", false) ? 1 : 0);

            /* Spectrum Extension */
            Log.i("ViPER4Android", "updateSystem(): Updating Spectrum Extension.");
            int nSEValue = Math.round(Float.valueOf(prefs.getString("viper4android.headphonefx.vse.value", "0.1")) * 5.6f * 100.0f);
            ...
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VSE_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.vse.enable", false) ? 1 : 0);
            ...
            if (!mWorkingWith3rd)
            {
                ...
                v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_FIREQ_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.fireq.enable", false) ? 1 : 0);
            }
            else
            {
                if (m3rdEqualizerLevels != null)
                ...
                v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_FIREQ_PROCESS_ENABLED, m3rdEqualizerEnabled ? 1 : 0);
            }

            /* Convolver */
            Log.i("ViPER4Android", "updateSystem(): Updating Convolver.");
            String mConvIRFileName = prefs.getString("viper4android.headphonefx.convolver.kernel", "");
            v4aModule.setConvIRFile(mConvIRFileName, false);
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_CONV_CROSSCHANNEL, Integer.valueOf(prefs.getString("viper4android.headphonefx.convolver.crosschannel", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_CONV_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.convolver.enable", false) ? 1 : 0);

            /* Colorful Music (ViPER's Headphone 360) */
            Log.i("ViPER4Android", "updateSystem(): Updating Field Surround (Colorful Music).");
            String[] colorfulMusic = prefs.getString("viper4android.headphonefx.colorfulmusic.coeffs", "120;200").split(";");
            ...
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_COLM_MIDIMAGE, Integer.valueOf(prefs.getString("viper4android.headphonefx.colorfulmusic.midimage", "150")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_COLM_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.colorfulmusic.enable", false) ? 1 : 0);

            /* Diff Surround */
            Log.i("ViPER4Android", "updateSystem(): Updating Diff Surround.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_DIFFSURR_DELAYTIME, Integer.valueOf(prefs.getString("viper4android.headphonefx.diffsurr.delay", "500")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_DIFFSURR_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.diffsurr.enable", false)? 1 : 0);

            /* ViPER's Headphone Surround Engine + */
            Log.i("ViPER4Android", "updateSystem(): Updating ViPER's Headphone Surround Engine +.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VHE_EFFECT_LEVEL, Integer.valueOf(prefs.getString("viper4android.headphonefx.vhs.qual", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VHE_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.vhs.enable", false) ? 1 : 0);

            /* ViPER's Reverberation */
            Log.i("ViPER4Android", "updateSystem(): Updating Reverberation.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_REVB_ROOMSIZE, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.roomsize", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_REVB_WIDTH, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.roomwidth", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_REVB_DAMP, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.damp", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_REVB_WET, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.wet", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_REVB_DRY, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.dry", "50")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_REVB_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.reverb.enable", false) ? 1 : 0);

            /* Playback Auto Gain Control */
            Log.i("ViPER4Android", "updateSystem(): Updating Playback AGC.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_AGC_RATIO, Integer.valueOf(prefs.getString("viper4android.headphonefx.playbackgain.ratio", "50")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_AGC_VOLUME, Integer.valueOf(prefs.getString("viper4android.headphonefx.playbackgain.volume", "80")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_AGC_MAXSCALER, Integer.valueOf(prefs.getString("viper4android.headphonefx.playbackgain.maxscaler", "400")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_AGC_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.playbackgain.enable", false) ? 1 : 0);
            ...
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_DYNSYS_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.dynamicsystem.enable", false) ? 1 : 0);

            /* Fidelity Control */
            Log.i("ViPER4Android", "updateSystem(): Updating Fidelity Control.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VIPERBASS_MODE, Integer.valueOf(prefs.getString("viper4android.headphonefx.fidelity.bass.mode", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VIPERBASS_SPEAKER, Integer.valueOf(prefs.getString("viper4android.headphonefx.fidelity.bass.freq", "40")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VIPERBASS_BASSGAIN, Integer.valueOf(prefs.getString("viper4android.headphonefx.fidelity.bass.gain", "50")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VIPERBASS_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.fidelity.bass.enable", false) ? 1 : 0);
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VIPERCLARITY_MODE, Integer.valueOf(prefs.getString("viper4android.headphonefx.fidelity.clarity.mode", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VIPERCLARITY_CLARITY, Integer.valueOf(prefs.getString("viper4android.headphonefx.fidelity.clarity.gain", "50")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_VIPERCLARITY_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.fidelity.clarity.enable", false) ? 1 : 0);

            /* Cure System */
            Log.i("ViPER4Android", "updateSystem(): Updating Cure System.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_CURE_CROSSFEED, Integer.valueOf(prefs.getString("viper4android.headphonefx.cure.crossfeed", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_CURE_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.cure.enable", false) ? 1 : 0);

            /* Tube Simulator */
            Log.i("ViPER4Android", "updateSystem(): Updating Tube Simulator.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_TUBE_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.tube.enable", false) ? 1 : 0);

            /* AnalogX */
            Log.i("ViPER4Android", "updateSystem(): Updating AnalogX.");
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_ANALOGX_MODE, Integer.valueOf(prefs.getString("viper4android.headphonefx.analogx.mode", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_ANALOGX_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.analogx.enable", false) ? 1 : 0);
            ...
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_OUTPUT_VOLUME, Integer.valueOf(prefs.getString("viper4android.headphonefx.outvol", "100")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_OUTPUT_PAN, Integer.valueOf(prefs.getString("viper4android.headphonefx.channelpan", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_HPFX_LIMITER_THRESHOLD, Integer.valueOf(prefs.getString("viper4android.headphonefx.limiter", "100")));

            /* Master Switch */
            if (!mWorkingWith3rd)
            {
                v4aModule.setParameter_px4_vx4x1(PARAM_SET_FORCEENABLE_STATUS, prefs.getBoolean("viper4android.global.forceenable.enable", false) ? 1 : 0);
                boolean masterControl = prefs.getBoolean("viper4android.headphonefx.enable", false);
                if (mMasterSwitchOff)
                    masterControl = false;
                v4aModule.setParameter_px4_vx4x1(PARAM_SET_DOPROCESS_STATUS, masterControl ? 1 : 0);
                v4aModule.mInstance.setEnabled(masterControl);
            }
            else
            {
                v4aModule.setParameter_px4_vx4x1(PARAM_SET_DOPROCESS_STATUS, m3rdEnabled ? 1 : 0);
                v4aModule.mInstance.setEnabled(m3rdEnabled);
            }
        }
        /******************************************************************************************************/
        /********************************************* Speaker FX *********************************************/
        else if (mFXType == V4A_FX_TYPE_SPEAKER)
        {
            ...
            /* FIR Equalizer */
            Log.i("ViPER4Android", "updateSystem(): Updating FIREqualizer.");
            if (!mWorkingWith3rd)
            {
                if (mOverriddenEqualizerLevels != null)
                {
                ...
                v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_FIREQ_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.fireq.enable", false) ? 1 : 0);
            }
            else
            {
                if (m3rdEqualizerLevels != null)
                    for (int i = 0; i < m3rdEqualizerLevels.length; i++)
                        setV4AEqualizerBandLevel(i, Math.round(m3rdEqualizerLevels[i] * 100), false, v4aModule);
                v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_FIREQ_PROCESS_ENABLED, m3rdEqualizerEnabled ? 1 : 0);
            }

            /* ViPER's Reverberation */
            Log.i("ViPER4Android", "updateSystem(): Updating Reverberation.");
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_REVB_ROOMSIZE, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.roomsize", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_REVB_WIDTH, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.roomwidth", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_REVB_DAMP, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.damp", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_REVB_WET, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.wet", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_REVB_DRY, Integer.valueOf(prefs.getString("viper4android.headphonefx.reverb.dry", "50")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_REVB_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.reverb.enable", false) ? 1 : 0);

            /* Convolver */
            Log.i("ViPER4Android", "updateSystem(): Updating Convolver.");
            String mConvIRFileName = prefs.getString("viper4android.headphonefx.convolver.kernel", "");
            v4aModule.setConvIRFile(mConvIRFileName, true);
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_CONV_CROSSCHANNEL, Integer.valueOf(prefs.getString("viper4android.headphonefx.convolver.crosschannel", "0")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_CONV_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.convolver.enable", false) ? 1 : 0);
            ...
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_CORR_PROCESS_ENABLED, prefs.getBoolean("viper4android.speakerfx.spkopt.enable", false) ? 1 : 0);

            /* eXtraLoud */
            Log.i("ViPER4Android", "updateSystem(): Updating eXtraLoud.");
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_AGC_RATIO, Integer.valueOf(prefs.getString("viper4android.headphonefx.playbackgain.ratio", "50")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_AGC_VOLUME, Integer.valueOf(prefs.getString("viper4android.headphonefx.playbackgain.volume", "80")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_AGC_MAXSCALER, Integer.valueOf(prefs.getString("viper4android.headphonefx.playbackgain.maxscaler", "400")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_AGC_PROCESS_ENABLED, prefs.getBoolean("viper4android.headphonefx.playbackgain.enable", false) ? 1 : 0);

            /* Limiter */
            Log.i("ViPER4Android", "updateSystem(): Updating Limiter.");
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_OUTPUT_VOLUME, Integer.valueOf(prefs.getString("viper4android.headphonefx.outvol", "100")));
            v4aModule.setParameter_px4_vx4x1(PARAM_SPKFX_LIMITER_THRESHOLD, Integer.valueOf(prefs.getString("viper4android.speakerfx.limiter", "100")));

            /* Master Switch */
            if (!mWorkingWith3rd)
            {
                v4aModule.setParameter_px4_vx4x1(PARAM_SET_FORCEENABLE_STATUS, prefs.getBoolean("viper4android.global.forceenable.enable", false) ? 1 : 0);
                boolean masterControl = prefs.getBoolean("viper4android.speakerfx.enable", false);
                if (mMasterSwitchOff)
                    masterControl = false;
                v4aModule.setParameter_px4_vx4x1(PARAM_SET_DOPROCESS_STATUS, masterControl ? 1 : 0);
                v4aModule.mInstance.setEnabled(masterControl);
    ...
    public boolean setParameterPreference(String pref, Object value)
    {
        if (mGeneralFX == null || mGeneralFX.mInstance == null || !mDriverIsReady)
        {
            Log.i("ViPER4Android", "updateSystem(): Effects is invalid!");
        ...
        {
            /* ViPER DDC */
            case "viper4android.headphonefx.viperddc.device":
                float[] ddcCoeffs = (float[])value;
                if (ddcCoeffs != null)
                    mGeneralFX.setParameter_px4_vx1x1024(PARAM_HPFX_VDDC_COEFFS, ddcCoeffs);
                break;

            /* Playback Auto Gain Control */
            case "viper4android.headphonefx.playbackgain.maxscaler":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_AGC_MAXSCALER, Integer.valueOf(value.toString()));
                break;
            case "viper4android.headphonefx.playbackgain.volume":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_AGC_VOLUME, (Integer)value);
                break;
            /* Spectrum Extension */
            case "viper4android.headphonefx.vse.value":
                int nSEValue = Math.round(Float.valueOf((String)value) * 5.6f * 100.0f);
                ...
                break;
            /* Convolver */
            case "viper4android.headphonefx.convolver.crosschannel":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_CONV_CROSSCHANNEL, (Integer)value);
                break;
            /* Colorful Music (ViPER's Headphone 360) */
            case "viper4android.headphonefx.colorfulmusic.coeffs":
                String[] colorfulMusic = ((String)value).split(";");
                if (colorfulMusic.length != 2)
                    return false;
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_COLM_WIDENING, Integer.valueOf(colorfulMusic[0]));
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_COLM_DEPTH, Integer.valueOf(colorfulMusic[1]));
                break;
            case "viper4android.headphonefx.colorfulmusic.midimage":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_COLM_MIDIMAGE, Integer.valueOf(value.toString()));
                break;
            /* Diff Surround */
            case "viper4android.headphonefx.diffsurr.delay":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_DIFFSURR_DELAYTIME, (Integer)value);
                break;
            /* ViPER's Headphone Surround Engine + */
            case "viper4android.headphonefx.vhs.qual":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_VHE_EFFECT_LEVEL, Integer.valueOf(value.toString()));
                break;
            /* ViPER's Reverberation */
            case "viper4android.headphonefx.reverb.roomsize":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_REVB_ROOMSIZE, Integer.valueOf(value.toString()));
                break;
            case "viper4android.headphonefx.reverb.roomwidth":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_REVB_WIDTH, (Integer)value);
                break;
            case "viper4android.headphonefx.reverb.damp":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_REVB_DAMP, (Integer)value);
                break;
            case "viper4android.headphonefx.reverb.wet":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_REVB_WET, (Integer)value);
                break;
            case "viper4android.headphonefx.reverb.dry":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_REVB_DRY, (Integer)value);
                break;
            /* Dynamic System */
            case "viper4android.headphonefx.dynamicsystem.bass":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_DYNSYS_BASSGAIN, (Integer)value * 20 + 100);
                break;
            /* Fidelity Control */
            case "viper4android.headphonefx.fidelity.bass.mode":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_VIPERBASS_MODE, Integer.valueOf(value.toString()));
                break;
            case "viper4android.headphonefx.fidelity.bass.freq":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_VIPERBASS_SPEAKER, (Integer)value);
                break;
            case "viper4android.headphonefx.fidelity.bass.gain":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_VIPERBASS_BASSGAIN, (Integer)value);
                break;
            case "viper4android.headphonefx.fidelity.clarity.mode":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_VIPERCLARITY_MODE, Integer.valueOf(value.toString()));
                break;
            case "viper4android.headphonefx.fidelity.clarity.gain":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_VIPERCLARITY_CLARITY, (Integer)value);
                break;
            /* Limiter */
            case "viper4android.headphonefx.outvol":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_OUTPUT_VOLUME, (Integer)value);
                break;
            case "viper4android.headphonefx.channelpan":
                mGeneralFX.setParameter_px4_vx4x1(PARAM_HPFX_OUTPUT_PAN, (Integer)value);
                break;
